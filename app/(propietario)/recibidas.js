...
const styles = StyleSheet.create({
  ...
  card:             { backgroundColor: '#2196F3', borderRadius: 12, padding: 16, marginBottom: 12,
  ...
  botonAcceso:      { backgroundColor: '#2196F3', borderRadius: 10, padding: 14, alignItems: 'center' },
  botonSalida:      { backgroundColor: '#2196F3' },
  ...
  bleDotActivo:    { backgroundColor: '#22C55E' },
  bleDotBeacon:    { backgroundColor: '#F59E0B' },
